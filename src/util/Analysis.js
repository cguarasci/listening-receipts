const Analysis = {
    analyzeTracks(tracks) {
        ...
        const chiropractorArtistNames = ["Skrillex", "GRiZ", "Four Tet", "Deadmau5", "Tiësto", "Steve Aoki", "Alesso", "Hardwell", "Alan Walker", "Kygo", "Armin van Buuren", "Above & Beyond", "Nero", "Kaskade", "Excision", "Major Lazer", "Bassnectar", "Zeds Dead", "RL Grime", "Slander", "Yellow Claw", "Don Diablo", "R3hab", "Sander van Doorn", "Axwell Λ Ingrosso", "Nicky Romero", "Flosstradamus", "Martin Solveig", "Knife Party", "Cashmere Cat", "Alison Wonderland", "Jauz", "What So Not", "Duke Dumont", "NGHTMRE", "Gryffin", "Morgan Page", "Carnage", "Tchami", "Getter", "A-Trak", "Alok", "KSHMR", "Benny Benassi", "Audien", "Adventure Club", "DVBBS", "Borgore", "Gorgon City", "Sick Individuals", "Krewella", "TJR", "Malaa", "Dombresky", "Paul Van Dyk", "Markus Schulz", "Oliver Heldens", "Nervo", "Deorro", "Lost Frequencies", "Feed Me", "Cash Cash", "W&W", "Don Diablo", "Borgeous", "3LAU", "Getter", "Breathe Carolina", "EDX", "Bassjackers", "Mat Zo", "MitiS", "Moon Boots", "Boombox Cartel", "Ghastly", "Tritonal", "Zomboy", "Lane 8", "Cheat Codes", "Bear Grillz", "Gammer", "Dirty South", "Skrillex", "Excision", "Zeds Dead", "NGHTMRE", "Virtual Riot", "Bassnectar", "The Glitch Mob", "Snails", "Slander", "Flosstradamus", "Rezz", "Noisia", "Pegboard Nerds", "Modestep", "Getter", "Svdden Death", "12th Planet", "Bear Grillz", "Eptic", "Subtronics", "Space Laces", "PhaseOne", "Must Die!", "Midnight Tyrannosaurus", "Trampa", "Doctor P", "Dirtyphonics", "Riot Ten", "Herobust", "Spag Heddy", "Kompany", "Soltan", "Zomboy", "Rusko", "Gentlemens Club", "Dubloadz", "Chime", "Badklaat", "Ivory", "Downlink", "Habstrakt", "Ray Volpe", "Mastadon", "Eliminate", "Fox Stevenson", "Samplifire", "Oddprophet", "Aweminus", "Calcium", "Graphyt", "Effin", "Oddprophet", "Phiso", "Jiqui", "Blankface", "Krimer", "Svddendeath", "Yookie", "Zeds Dead", "Slander", "Spag Heddy", "Mastadon", "Chime", "Rusko", "Herobust", "Gentlemens Club", "Badklaat", "Dubloadz", "Trampa", "Zomboy", "Riot Ten", "Ray Volpe", "Bear Grillz", "Kompany", "Must Die!", "Doctor P", "Soltan", "Subtronics", "Downlink", "12th Planet", "Snails", "Getter", "Modestep", "Pegboard Nerds", "Noisia", "Rezz", "Flosstradamus", "Dirtyphonics", "PhaseOne", "Space Laces", "Virtual Riot", "NGHTMRE", "Zeds Dead", "Excision",];
        const countryArtistNames = ["Megan Moroney", "Nate Smith", "Chris Stapleton", "Ella Langley", "Parker McCollum", "John Morgan", "Lainey Wilson", "Bailey Zimmerman", "Dalton Dover", "Corey Kent", "Luke Combs", "Carly Pearce", "Shaylen", "Luke Bryan", "Johnny Cash", "Willie Nelson", "Dolly Parton", "Hank Williams", "Patsy Cline", "George Jones", "Loretta Lynn", "Merle Haggard", "Waylon Jennings", "Tammy Wynette", "Kenny Rogers", "John Denver", "Reba McEntire", "Alan Jackson", "Garth Brooks", "Shania Twain", "Tim McGraw", "Faith Hill", "George Strait", "Martina McBride", "Vince Gill", "Trisha Yearwood", "Brooks & Dunn", "Randy Travis", "Toby Keith", "Kris Kristofferson", "Emmylou Harris", "Alabama", "Charlie Pride", "Dwight Yoakam", "Dixie Chicks", "Brad Paisley", "Miranda Lambert", "Blake Shelton", "Keith Urban", "Carrie Underwood", "Zac Brown Band", "Jason Aldean", "Luke Bryan", "Florida Georgia Line", "Eric Church", "Kacey Musgraves", "Chris Stapleton", "Thomas Rhett", "Maren Morris", "Sam Hunt", "Dierks Bentley", "Kenny Chesney", "Lady A", "Rascal Flatts", "Johnny Cash", "Willie Nelson", "Dolly Parton", "Hank Williams", "Patsy Cline", "George Jones", "Loretta Lynn", "Merle Haggard", "Waylon Jennings", "Tammy Wynette", "Kenny Rogers", "John Denver", "Reba McEntire", "Alan Jackson", "Garth Brooks", "Shania Twain", "Tim McGraw", "Faith Hill", "George Strait", "Martina McBride", "Vince Gill", "Trisha Yearwood", "Brooks & Dunn", "Randy Travis", "Toby Keith", "Kris Kristofferson", "Emmylou Harris", "Alabama", "Charlie Pride", "Dwight Yoakam", "Dixie Chicks", "Brad Paisley", "Miranda Lambert", "Blake Shelton", "Keith Urban", "Carrie Underwood", "Zac Brown Band", "Jason Aldean", "Luke Bryan", "Florida Georgia Line", "Eric Church", "Kacey Musgraves", "Chris Stapleton", "Thomas Rhett", "Maren Morris", "Sam Hunt", "Dierks Bentley", "Kenny Chesney", "Rascal Flatts"];
        ...
        tracks.forEach((track) => {
            ...
            //Farmers Only (by artist name)
            if (count.country === 0 && countryArtistNames.includes(track.artist.name)) {
                
                coupons.push({
                    description: "Thanks for your order of "  + track.artist.name + "! We have have identified from your purchase history that you might love this website as well. Create an account here and we'll extend you a special offer.",
                    image: "qr-codes/farmers-only.png"
                });
